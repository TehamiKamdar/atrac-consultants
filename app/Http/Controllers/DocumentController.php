...
class DocumentController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $folderName = 'documents/' . strtolower(str_replace(' ', '', $student->first_name)) . '_' . strtolower(str_replace(' ', '', $student->last_name)) . '_' . strtolower(str_replace(' ', '', $student->intake)) . '_documents';
